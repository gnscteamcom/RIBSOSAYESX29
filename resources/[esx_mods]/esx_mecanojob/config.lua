...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = -204.765, y = -1342.827, z = 30.0 },
  ...
  Garage = {
    Pos   = { x = -199.829, y = -1315.193, z = 30.189 },
    Size  = { x = 1.0, y = 1.0, z = 1.0 },
    Color = { r = 0, g = 0, b = 255 },
    Type  = 27,
  },
  ...
  Craft = {
    Pos   = { x = -197.45, y = -1320.448, z = 30.189 },
    Size  = { x = 1.0, y = 1.0, z = 1.0 },
    Color = { r = 200, g = 204, b = 0 },
    Type  = 27,
  },
  ...
  VehicleDeleter = {
    Pos   = { x = -182.736, y = -1318.705, z = 30.298 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 0, b = 0 },
    Type  = 27,
  },
  ...
  VehicleDelivery = {
    Pos   = { x = -196.187, y = -1305.38, z = 31.422 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = -1,
  },
