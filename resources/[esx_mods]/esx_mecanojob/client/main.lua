    ...
    while true do
        ...
        if IsControlJustReleased(0, Keys['DELETE']) and PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
          ...
          if NPCOnJob then
            ...
            if IsPedInAnyVehicle(playerPed,  false) and IsVehicleModel(GetVehiclePedIsIn(playerPed,  false), GetHashKey("flatbed")) or IsVehicleModel(GetVehiclePedIsIn(playerPed,  false), GetHashKey("flatbed3")) then
              StartNPCJob()
            else
