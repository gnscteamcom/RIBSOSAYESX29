...
AddEventHandler('esx_basicneeds:resetStatus', function()
	TriggerEvent('esx_status:set', 'hunger', 1250000)
	TriggerEvent('esx_status:set', 'thirst', 1250000)
...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 1250000, '#CFAD0F',
		function(status)
			return true
		end,
		function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'thirst', 1250000, '#0C98F1',
		function(status)
			return true
		end,
		function(status)
