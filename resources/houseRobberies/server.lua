...
local robbableItems = {
 ...
 [2] = {chance = 30, id = 'WEAPON_PISTOL', name = 'Pistol', isWeapon = true}, -- rare
 [3] = {chance = 20, id = 'tuning_laptop', name = 'Tuner Laptop', quantity = 1}, -- rare
 [4] = {chance = 20, id = 'armor', name = 'Armour', quantity =  math.random(1, 2)}, -- common
 ...
 [15] = {chance = 10, id = 'goldNecklace', name = 'Gold Necklace', quantity = 1}, -- rare
 [16] = {chance = 12, id = 'handcuffs', name = 'handcuffs', quantity = 1}, -- rare
 [17] = {chance = 12, id = 'highradio', name = 'Aftermarket Radio', quantity = 1}, -- rare
 [18] = {chance = 7, id = 'jewels', name = 'Jewels', quantity = math.random(1, 25)}, -- rare
 [19] = {chance = 3, id = 'laptop', name = 'Laptop', quantity = 1}, -- rare
 ...
 [22] = {chance = 6, id = 'lsd', name = 'Lsd', quantity = 2}, 
 [23] = {chance = 8, id = 'marijuana', name = 'Bag of Weed', quantity = math.random(1, 5)}, 
 [24] = {chance = 9, id = 'medikit', name = 'Medikit', quantity = 1}, 
 [25] = {chance = 9, id = 'oxygen_mask', name = 'Oxygen Mask', quantity = 1}, 
 [26] = {chance = 6, id = 'ring', name = 'Ring', quantity = 2}, 
 [27] = {chance = 7, id = 'rolex', name = 'Rolex', quantity = math.random(1, 5)}, 
 [28] = {chance = 8, id = 'rope', name = 'X', quantity = 1},
 [29] = {chance = 8, id = 'samsungS10', name = 'Samsung Phone', quantity = 2}, 
 [30] = {chance = 8, id = 'spice', name = 'Bag of spice', quantity = 2}, 
 [31] = {chance = 8, id = 'vodka', name = 'Vodka', quantity = 1},
 [32] = {chance = 10, id = 'WEAPON_KNIFE', name = 'Combat knife', quantity = 1},
 [33] = {chance = 20, id = 'WEAPON_PIPEBOMB', name = 'Homemade bomb', quantity = math.random(1, 5)},
 [34] = {chance = 35, id = 'keycard', name = 'Keycard', quantity = 1},
